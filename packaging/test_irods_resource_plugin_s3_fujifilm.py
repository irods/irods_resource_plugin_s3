...
class Test_Compound_With_S3_Resource(Test_S3_Cache_Base, unittest.TestCase):
    def __init__(self, *args, **kwargs):
        """Set up the test."""
        self.keypairfile='/var/lib/irods/fujifilm.keypair'
        self.archive_naming_policy='decoupled'
        self.s3stsdate=''
        self.s3region='us-east4'
        self.s3endPoint = self.read_endpoint('/var/lib/irods/fujifilm_endpoint.txt')
        self.s3sse = 0 # server side encryption
        self.static_bucket_name = 'irods-testing'    # fuji does not allow deletion of buckets so force static bucket use
