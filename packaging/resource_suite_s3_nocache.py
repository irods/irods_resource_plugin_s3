...
OUTPUT ruleExecOut
    ...
    def test_istream_append__issue_2153(self):
        ...
        try:
            ...
            # append to the file
            self.user0.assert_icommand(['istream', 'write', '-a', logical_path], input=content_append1)

            # append to the file again
            self.user0.assert_icommand(['istream', 'write', '-a', logical_path], input=content_append2)
